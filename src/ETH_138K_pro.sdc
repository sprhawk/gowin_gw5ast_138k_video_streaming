...
//Created Time: 2025-09-16 11:51:29
...
set_clock_groups -asynchronous -group [get_clocks {rgmii_rxc}] -group [get_clocks {clk_50M}] -group [get_clocks {tck}] -group [get_clocks {clk_125M}] -group [get_clocks {xy2_pll_clk_8M}] -group [get_clocks {xy2_pll_clk_100M}]
